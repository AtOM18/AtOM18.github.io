...
Main website page: index.html [script.js, a.css]

Movie Generated page: movie.html [movie-site/script.js]

NOTE: Api will return 429 error when requests runs out Change the options variable in both script.js and movie-site/script.js options variable are added on the top of the page.
